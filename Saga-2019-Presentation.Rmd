...
# How do we compute the statial weights matrix?

Original feature: We use the locations of capital cities to estimate Thiessen polygons and recover a contiguity matrix from distance data. 
